...
SAVE_MODEL = True
DROP_CLASS = None
EXT = 'dropped_' + str(DROP_CLASS) if DROP_CLASS is not None else 'None'
...
if __name__ == '__main__':
    ...
    ds_train = MNISTMetricDataset(mnist_download_root, split='train', remove_class=DROP_CLASS)
    ...
    if SAVE_MODEL:
        torch.save(model.state_dict(), f'./weights/model_{EXT}.pth')
        print("Model saved!")